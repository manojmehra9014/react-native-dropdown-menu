...
const styles = StyleSheet.create({
  ...
  textItem: {
    flex: 1,
    fontSize: 16,
    color: '#000',  // Ensures dropdown item text color is black
  },
  placeholderStyle: {
    fontSize: 16,
  ...
  selectedTextStyle: {
    fontSize: 16,
    color: '#000',  // Selected item text color set to black
  },
  iconStyle: {
    width: 20,
    height: 20,
  ...
  inputSearchStyle: {
    height: 40,
    fontSize: 16,
    color: '#000',  // Input search text color set to black
  },
});
```
  ...
  return (
    <View style={styles.container}>
      <MultiSelect
        ...
        itemTextStyle={styles.itemTextStyle} // Dropdown items' text color set to black
        renderLeftIcon={() => (
          <AntDesign
            style={styles.icon}
            color="black"
        ...
        dropdownStyle={styles.dropdownStyle} // Dropdown background color set to white
      />
    </View>
  );
};
...
const styles = StyleSheet.create({
  ...
  dropdownStyle: {
    backgroundColor: 'white', // Dropdown background color set to white
  },
  placeholderStyle: {
    fontSize: 16,
    color: '#000', // Placeholder text color set to black
  ...
  iconStyle: {
    width: 20,
    height: 20,
    tintColor: '#000', // Set icon color to black if applicable
  },
  inputSearchStyle: {
    height: 40,
    fontSize: 16,
  ...
  itemTextStyle: {
    fontSize: 16,
    color: '#000', // Dropdown list items' text color set to black
  },
  selectedStyle: {
    borderRadius: 12,
  },
...
const styles = StyleSheet.create({
    ...
    selectedTextStyle: {
        fontSize: 14,
        color: 'black', // Color for selected text
    },
    selectedItem: {
        backgroundColor: '#d3d3d3', // Background color for selected item
    },
    iconStyle: {
        width: 20,
        height: 20,
    ...
    item: {
        ...
        justifyContent: 'space-between',
        alignItems: 'center',
        backgroundColor: 'white', // Default item background color
    },
    selectedItem: {
        backgroundColor: '#d3d3d3', // Background color for selected item
    },
    selectedStyle: {
        ...
        alignItems: 'center',
        borderRadius: 14,
        backgroundColor: '#fff', // Background color for selected items display
        shadowColor: '#000',
        marginTop: 8,
        marginRight: 12,
    ...
    textSelectedStyle: {
        marginRight: 5,
        fontSize: 16,
        color: 'black', // Color for selected item text
    },
    selectedText: {
        color: 'black', // Color for selected text in items
    },
});
```
